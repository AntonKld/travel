...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _slider.initToursSlider)();
    (0, _training.initTrainingSlider)();
    (0, _reviews.initReviewsSlider)();
    (0, _heroStyle.getHeaderAfterInnerChanging)(function (header) {
      (0, _heroStyle.getHeight)(header.offsetHeight);
    });
    (0, _heroStyle.getHeaderAfterWindowResizeChanging)(function (header) {
      (0, _heroStyle.getHeight)(header.offsetHeight);
    });
    var form = new _form.Form();
    window.form = form;
    form.init();
    (0, _heroStyle.initHero)();
    (0, _slider.heroSwiper)();
    (0, _burger.burgerMenuInit)();
    (0, _video.initPlayVideo)();
    (0, _advantages.initAdvantagesSlider)();
    (0, _gallery.initGallerySlider)();
...
},{"./modules/advantages":3,"./modules/audio":4,"./modules/burger.js":5,"./modules/form-validate/form":7,"./modules/gallery":13,"./modules/hero-style":14,"./modules/map":15,"./modules/reviews":16,"./modules/slider.js":17,"./modules/training":18,"./modules/video":19,"./utils/ios-vh-fix":21}],3:[function(require,module,exports){
"use strict";
...
var createSlider = function createSlider() {
  return new _swiper.default('.advantages__slider', {
    speed: 300,
    watchOverflow: true,
    loop: true,
    slidesPerView: 'auto',
...
var addAudioHandlers = function addAudioHandlers() {
  ...
  var parent = document.querySelector(HERO_SELECTOR);
  if (!parent) {
    return;
  }
...
},{"../utils/scroll-lock":22}],6:[function(require,module,exports){
"use strict";
...
exports.initHero = exports.getHeight = exports.getHeaderAfterWindowResizeChanging = exports.getHeaderAfterInnerChanging = void 0;
var hero = document.querySelector('.hero');
var header = document.querySelector('.page-header');
var content = document.querySelector('.hero__inner');
var getHeight = function getHeight(newTop) {
  if (!hero) {
    return;
  }
  hero.style.marginTop = "".concat(-newTop, "px");
  content.style.paddingTop = "".concat(newTop, "px");
};
...
var initHero = function initHero() {
  var block = document.querySelector('.hero');
...
var initContactsMap = function initContactsMap() {
  if (document.querySelector('#map')) {
    ...
    var coordinate = [55.774864, 37.632545];
...
},{"../../../node_modules/leaflet/dist/leaflet":1}],16:[function(require,module,exports){
"use strict";
...
exports.initToursSlider = exports.heroSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var initToursSlider = function initToursSlider() {
  var slider = new _swiper.default('.tours__slider', {
    direction: 'horizontal',
    watchOverflow: true,
    speed: 300,
    breakpoints: {
...
var initTrainingSlider = function initTrainingSlider() {
  var slider = new _swiper.default('.training__slider', {
    direction: 'horizontal',
    speed: 300,
    slidesPerView: 4,
    spaceBetween: 30,
